...
window.onload = function() {
    ...
    const config = {
        ...
        scene: [TitleScene, GameScene], // Remove ControlsScene from startup sequence
        fps: { 
...
class TitleScene extends Phaser.Scene {
    ...
    create() {
        ...
        const instructionsText = this.add.text(
            ...
            'Press ESC during gameplay to see controls',
            {
                fontFamily: 'Space Grotesk',
                fontSize: '20px',
                color: '#cccccc',
...
// Keep the ControlsScene class as a reference for the pause screen,
// but we'll no longer use it directly in the scene flow
